...
ex:alice   ex:age "42"^^xsd:untypedAtomic .
ex:bob     ex:age "25"^^xsd:untypedAtomic .
ex:charlie ex:age "37.5"^^xsd:untypedAtomic .
ex:dave    ex:age "invalid"^^xsd:untypedAtomic .
              `,
              mediaType: 'text/turtle',
              baseIRI: 'http://example.org/',
            },
...
WHERE {
  ...
  FILTER(?age > 30)
        ...
        `, context)).resolves.toEqualBindingsStream([
          BF.bindings([
            [ DF.variable('person'), DF.namedNode('http://example.org/alice') ],
            [ DF.variable('age'), DF.literal('42', DF.namedNode('http://www.w3.org/2001/XMLSchema#untypedAtomic')) ],
          ]),
          BF.bindings([
            [ DF.variable('person'), DF.namedNode('http://example.org/charlie') ],
            [ DF.variable('age'), DF.literal('37.5', DF.namedNode('http://www.w3.org/2001/XMLSchema#untypedAtomic')) ],
          ]),
        ]);
      });
