...
import type { IActorQueryOperationOutputBindings, TPatternBindings } from '@comunica/types';
...
describe('ActorQueryOperationBgpLeftDeepSmallest', () => {
  ...
  describe('Static ActorQueryOperationBgpLeftDeepSmallest', () => {
    ...
    describe('createLeftDeepStream', () => {
      const binder: any =
        (patterns: { pattern: Algebra.Pattern; bindings: TPatternBindings }[]) => new SingletonIterator(
          Bindings({
