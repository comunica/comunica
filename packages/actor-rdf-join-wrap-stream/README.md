...
An [RDF Join](https://github.com/comunica/comunica/tree/master/packages/bus-rdf-join) actor that calls the `bus-iterator-transform` for all iterators produced by `query-operation` actors.
