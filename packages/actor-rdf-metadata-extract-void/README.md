...
* `voidDatasets`: An array containing the extracted VoID dataset definitions.
...
* `inferUriRegexPattern`: Whether a missing `void:uriRegexPattern` should be inferred.
* `bindingsCacheSize`: How many bindings should be cached internally for cardinality estimation.
