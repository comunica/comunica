 ...
 */
export class ActorContextPreprocessInitializeLinkTraversalManager extends ActorContextPreprocess {
  ...
  public constructor(args: IActorContextPreprocessInitializeLinkTraversalManagerArgs) {
    super(args);
  }
...
export interface IActorContextPreprocessInitializeLinkTraversalManagerArgs extends IActorContextPreprocessArgs {
  /**
