...
capable of evaluating the [Xsd To Date](https://www.w3.org/TR/sparql11-query/#FunctionMapping) function.
...
```text
{
  "@context": [
    ...
    "https://linkedsoftwaredependencies.org/bundles/npm/@comunica/actor-function-factory-term-xsd-to-date/^5.0.0/components/context.jsonld"
  ],
  "actors": [
    ...
    {
