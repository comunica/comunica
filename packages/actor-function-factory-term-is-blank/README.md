...
[![npm version](https://badge.fury.io/js/%40comunica%2Factor-function-factory-term-is-blank.svg)](https://www.npmjs.com/package/@comunica/actor-function-factory-term-is-blank)
...
```text
{
  "@context": [
    ...
    "https://linkedsoftwaredependencies.org/bundles/npm/@comunica/actor-function-factory-term-is-blank/^5.0.0/components/context.jsonld"
  ],
  "actors": [
    ...
    {
