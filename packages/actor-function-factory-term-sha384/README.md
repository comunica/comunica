...
capable of evaluating the [Sha384](https://www.w3.org/TR/sparql11-query/#func-sha384) function.
...
```text
{
  "@context": [
    ...
    "https://linkedsoftwaredependencies.org/bundles/npm/@comunica/actor-function-factory-term-function-sha384/^5.0.0/components/context.jsonld"
  ],
  "actors": [
    ...
    {
