...
export class ActorQueryOperationValues extends ActorQueryOperationTyped<Algebra.Values> {
  ...
  public async testOperation(pattern: Algebra.Values, context?: {[id: string]: any}): Promise<IActorTest> {
    return true;
  }

  public async runOperation(pattern: Algebra.Values, context?: {[id: string]: any})
