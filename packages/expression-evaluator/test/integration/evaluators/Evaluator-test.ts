  ...
  describe('SyncEvaluator', () => {
    describe('evaluate', () => {
      it('is able to evaluate', () => {
        const evaluator = new SyncEvaluator(DF, parse('1 + 1'));
      ...
      it('has proper extended XSD type support', () => {
        const evaluator = new SyncEvaluator(DF, parse('1 + "1"^^<http://example.com>'));
    ...
    describe('evaluateAsEBV', () => {
      ...
      it('is able to evaluate to false', () => {
        const evaluator = new SyncEvaluator(DF, parse('0'));
  ...
  describe('AsyncEvaluator', () => {
    describe('evaluate', () => {
      it('is able to evaluate', async() => {
        const evaluator = new AsyncEvaluator(DF, parse('1 + 1'));
      ...
      it('has proper extended XSD type support', async() => {
        const evaluator = new AsyncEvaluator(DF, parse('1 + "1"^^<http://example.com>'));
    ...
    describe('evaluateAsEBV', () => {
      ...
      it('is able to evaluate to false', async() => {
        const evaluator = new AsyncEvaluator(DF, parse('0'));
