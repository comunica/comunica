# Comunica Inner Single RDF Join Actor
...
```text
{
  "@context": [
    ...
    "https://linkedsoftwaredependencies.org/bundles/npm/@comunica/actor-rdf-join-inner-single/^5.0.0/components/context.jsonld"
  ],
  "actors": [
    ...
    {
