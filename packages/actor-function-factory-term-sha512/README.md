...
[![npm version](https://badge.fury.io/js/%40comunica%2Factor-function-factory-term-sha512.svg)](https://www.npmjs.com/package/@comunica/actor-function-factory-term-sha512)
...
```bash
$ yarn add @comunica/actor-function-factory-term-sha512
```
...
```text
{
  "@context": [
    ...
    "https://linkedsoftwaredependencies.org/bundles/npm/@comunica/actor-function-factory-term-function-sha512/^5.0.0/components/context.jsonld"
  ],
  "actors": [
    ...
    {
