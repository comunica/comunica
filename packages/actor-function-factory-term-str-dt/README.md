...
[![npm version](https://badge.fury.io/js/%40comunica%2Factor-function-factory-term-str-dt.svg)](https://www.npmjs.com/package/@comunica/actor-function-factory-term-str-dt)
...
```text
{
  "@context": [
    ...
    "https://linkedsoftwaredependencies.org/bundles/npm/@comunica/actor-function-factory-term-str-dt/^5.0.0/components/context.jsonld"
  ],
  "actors": [
    ...
    {
