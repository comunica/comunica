# Comunica Path OneOrMore Query Operation Actor
...
```text
{
  "@context": [
    ...
    "https://linkedsoftwaredependencies.org/bundles/npm/@comunica/actor-query-operation-path-one-or-more/^4.0.0/components/context.jsonld"
  ],
  "actors": [
    ...
    {
