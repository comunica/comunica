...
import {ActorQueryOperationTyped, IActorQueryOperationTypedArgs} from "./ActorQueryOperationTyped";
...
export interface IActorQueryOperationTypedMediatedArgs extends IActorQueryOperationTypedArgs {
