...
[![npm version](https://badge.fury.io/js/%40comunica%2Factor-function-factory-term-sub-str.svg)](https://www.npmjs.com/package/@comunica/actor-function-factory-term-sub-str)
...
```text
{
  "@context": [
    ...
    "https://linkedsoftwaredependencies.org/bundles/npm/@comunica/actor-function-factory-term-sub-str/^5.0.0/components/context.jsonld"
  ],
  "actors": [
    ...
    {
