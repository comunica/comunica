...
import type { TActorQueryOperationOutput, IActorQueryOperationOutputQuads } from '@comunica/types';
...
export class ActorSparqlSerializeRdf extends ActorSparqlSerialize implements IActorSparqlSerializeRdfArgs {
  ...
  public async testHandle(action: TActorQueryOperationOutput, mediaType: string, context?: ActionContext):
  Promise<IActorTest> {
  ...
  public async runHandle(action: TActorQueryOperationOutput, mediaType: string, context?: ActionContext):
