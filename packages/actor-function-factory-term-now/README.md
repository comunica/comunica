# Comunica Term Function Now Function Factory Actor

[![npm version](https://badge.fury.io/js/%40comunica%2Factor-function-factory-term-now.svg)](https://www.npmjs.com/package/@comunica/actor-function-factory-term-now)
...
```text
{
  "@context": [
    ...
    "https://linkedsoftwaredependencies.org/bundles/npm/@comunica/actor-function-factory-term-now/^5.0.0/components/context.jsonld"
  ],
  "actors": [
    ...
    {
