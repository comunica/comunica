...
capable of evaluating the [Triple](https://w3c.github.io/rdf-star/cg-spec/editors_draft.html#triple-function) function.
...
```text
{
  "@context": [
    ...
    "https://linkedsoftwaredependencies.org/bundles/npm/@comunica/actor-function-factory-term-triple/^5.0.0/components/context.jsonld"
  ],
  "actors": [
    ...
    {
