# Comunica Term Function Month Function Factory Actor

[![npm version](https://badge.fury.io/js/%40comunica%2Factor-function-factory-term-month.svg)](https://www.npmjs.com/package/@comunica/actor-function-factory-term-month)
...
```text
{
  "@context": [
    ...
    "https://linkedsoftwaredependencies.org/bundles/npm/@comunica/actor-function-factory-term-month/^5.0.0/components/context.jsonld"
  ],
  "actors": [
    ...
    {
