...
import type { ISerializable } from '@comunica/expression-evaluator/lib/expressions';
import {
  IntegerLiteral,
  isLiteralTermExpression,
  Literal,
  StringLiteral,
} from '@comunica/expression-evaluator/lib/expressions';
import type { FunctionArgumentsCache } from '@comunica/expression-evaluator/lib/functions/OverloadTree';
import { OverloadTree } from '@comunica/expression-evaluator/lib/functions/OverloadTree';
import type { KnownLiteralTypes } from '@comunica/expression-evaluator/lib/util/Consts';
...
import { regularFunctions } from '../../lib/implementation';
