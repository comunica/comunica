...
describe('CachePolicyHttpCacheSemanticsWrapper', () => {
  ...
  beforeEach(() => {
    ...
    wrapper = new CachePolicyHttpCacheSemanticsWrapper(cachePolicy);
  });
  ...
  describe('satisfiesWithoutRevalidation', () => {
    it('is delegated to the cachePolicy', async() => {
      ...
      await expect(wrapper.satisfiesWithoutRevalidation(new Request(
        'http://localhost:8080/',
  ...
  describe('revalidationHeaders', () => {
    it('is delegated to the cachePolicy', async() => {
      ...
      await expect(wrapper.revalidationHeaders(new Request(
        'http://localhost:8080/',
        { headers: new Headers({ a: 'b' }) },
  ...
  describe('revalidatedPolicy', () => {
    it('is delegated to the cachePolicy', async() => {
      ...
      await expect(wrapper.revalidatedPolicy(new Request(
        'http://localhost:8080/',
        { headers: new Headers({ a: 'b' }) },
